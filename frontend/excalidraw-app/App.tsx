...
// OverwriteConfirmDialog is rendered by the core LayerUI; we don't use it directly
    ...
    >
      ...
      >
        ...
        <AppWelcomeScreen
          ...
          isCollabEnabled={!isCollabDisabled}
        />
        {/* Use default Save to... dialog; custom cards are injected via renderCustomUI */}
        {excalidrawAPI && (
          <OpenDialog
